...
class Session(object):
    ...
    get_events - returns the dictionary of events for this session 
    ...
    def handle_event(self, event):
        ...
        # If there isn't a control currently assigned
        # or it doesn't know how to handle this event, carry on as normal.
        if self.control is None or not self.control.handle_event(event):
    ...
    def add_keydown(self, handler, always_active=False, **kwargs):
        ...
        """
        return self.add_handler(pygame.KEYDOWN, handler,
                                always_active=always_active, **kwargs)

    def add_keyup(self, handler, always_active=False, **kwargs):
        """See the documentation for self.add_keydown."""
        return self.add_handler(pygame.KEYUP, handler,
                                always_active=always_active, **kwargs)
